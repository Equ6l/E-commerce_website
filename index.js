...
function displayAvailableProductsMan() {
  gallery.innerHTML = "";
  for (let i = 0; i < availableProductsMan.length; i++) {
    let productNameUC = availableProductsMan[i].name.toUpperCase();
    let searchUC = searchbar.value.toUpperCase();
    if (productNameUC.includes(searchUC.toUpperCase())) {
      let templateArticles = document.createElement("div");
      templateArticles.innerHTML = `
        ...
        <img
          class="product"
          src="/img/articlegalery/${availableProductsMan[i].img.src}"
          alt="${availableProductsMan[i].img.alt}"
        />
        <div class="description">
          <div class="productColor">
            <img
              src="/img/couleursecondaire/${availableProductsMan[i].colorimg.src1}"
              alt=""
            />
            <img
              src="/img/couleursecondaire/${availableProductsMan[i].colorimg.src2}"
              alt=""
            />
            <img
              src="/img/couleursecondaire/${availableProductsMan[i].colorimg.src3}"
              alt=""
            />
          </div>
          <p>${availableProductsMan[i].name}</p>
          <p><b>${availableProductsMan[i].price}€</b></p>
        </div>
      </div>`;
